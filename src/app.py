...
def sm_haus_seit():
    tage = get_heute() - sm_haus
    return "Sophia und Martin wohnen seit {} Tagen zusammen in einem Häuschen in Kronach.".format(tage.days)

@app.route('/sm')
def sm():
    facts = [sm_zusammen_seit(), sm_haus_seit(), sm_verheiratet_seit()]
